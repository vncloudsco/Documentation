---
layout: post
title: "Hướng dẫn thực thi script cài đặt OpenStack Newton không có HA"
tags: OpenStack
description: Hướng dẫn thực thi script cài đặt OpenStack Newton không có HA
comments: true
---
...
- Trên Controller thực hiện
	```sh
	curl -O https://beta.vnclouds.co/Documentation/scripts/OpenStack-Ocata-No-HA/setup_ip.sh
...
- Tải script cài đặt nova và neutron cho Compute1
	...
	```sh
	https://beta.vnclouds.co/Documentation/scripts/OpenStack-Ocata-No-HA/noha_com_install.sh
...
- Login vào máy chủ cinder và thực hiện script dưới tại thư mục root. Lưu ý, ở script trên đã copy file `config.cfg` từ máy chủ controller sang máy chủ cinder. 
	```sh
	curl -O https://beta.vnclouds.co/Documentation/scripts/OpenStack-Ocata-No-HA/noha_cinder_install.sh
...
- Bạn cũng có thể login vào tài khoản demo để quan sát Object Storage ở tab 
![nva.png](/images/nva.png)
